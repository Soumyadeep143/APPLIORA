 ...
 * eyes and a warm smile, wearing a purple hoodie with a minimalist "A"
...
export default function Mascot({ mood = 'idle', message = '' }) {
  return (
    <div className={`mascot mood-${mood}`} role="status" aria-live="polite">
      ...
      >
        {/* ground shadow */}
        <ellipse className="m-shadow" cx="75" cy="140" rx="34" ry="5" fill="#1c1e26" opacity="0.12" />
        ...
        <g className="m-body-group">
          ...
          />
          {/* hood collar */}
          <path d="M61 73 Q75 82 89 73 Q89 66 75 67 Q61 66 61 73 Z" fill="#6d28d9" />
          {/* minimalist "A" emblem */}
          ...
          <g className="m-arm-wave">
            <path d="M53 84 Q40 74 36 60" fill="none" stroke="#7c3aed" strokeWidth="9" strokeLinecap="round" />
            <circle cx="35" cy="57" r="5.5" fill="#f6c39c" />
          </g>

          {/* both arms up (success) */}
          <g className="m-arms-up">
            <path d="M53 84 Q38 72 34 56" fill="none" stroke="#7c3aed" strokeWidth="9" strokeLinecap="round" />
            <circle cx="33" cy="53" r="5.5" fill="#f6c39c" />
            <path d="M97 84 Q112 72 116 56" fill="none" stroke="#7c3aed" strokeWidth="9" strokeLinecap="round" />
            <circle cx="117" cy="53" r="5.5" fill="#f6c39c" />
          </g>

          {/* glowing job listing on the screen (light spills over the lid) */}
          <ellipse className="m-glow" cx="75" cy="106" rx="36" ry="11" fill="#a78bfa" opacity="0.4" />

          {/* laptop (back of the lid faces us) */}
          <rect x="42" y="104" width="66" height="30" rx="7" fill="#e2e5f5" stroke="#c7cbe8" strokeWidth="1.5" />
          <circle cx="75" cy="119" r="3.2" fill="#7c3aed" />
          <rect x="37" y="133" width="76" height="5" rx="2.5" fill="#c7cbe8" />

          {/* resting hands on the lid */}
          <g className="m-arms-rest">
            <path d="M52 86 Q44 94 47 102" fill="none" stroke="#7c3aed" strokeWidth="9" strokeLinecap="round" />
            <circle cx="48" cy="103" r="5" fill="#f6c39c" />
            <path d="M98 86 Q106 94 103 102" fill="none" stroke="#7c3aed" strokeWidth="9" strokeLinecap="round" />
        ...
        <g className="m-docs">
          <g className="m-doc d1">
            <rect x="103" y="62" width="15" height="19" rx="2" fill="#fff" stroke="#c7cbe8" strokeWidth="1.2" />
            <line x1="106" y1="68" x2="115" y2="68" stroke="#7c3aed" strokeWidth="1.6" strokeLinecap="round" />
            <line x1="106" y1="72" x2="115" y2="72" stroke="#c7cbe8" strokeWidth="1.6" strokeLinecap="round" />
            <line x1="106" y1="76" x2="112" y2="76" stroke="#c7cbe8" strokeWidth="1.6" strokeLinecap="round" />
          </g>
          <g className="m-doc d2">
            <rect x="118" y="82" width="11" height="14" rx="2" fill="#fff" stroke="#c7cbe8" strokeWidth="1.2" />
            <line x1="120.5" y1="87" x2="126.5" y2="87" stroke="#60a5fa" strokeWidth="1.4" strokeLinecap="round" />
            <line x1="120.5" y1="90.5" x2="126.5" y2="90.5" stroke="#c7cbe8" strokeWidth="1.4" strokeLinecap="round" />
          </g>
          <circle className="m-particle p1" cx="112" cy="56" r="2.2" fill="#8b5cf6" />
          <circle className="m-particle p2" cx="126" cy="70" r="1.8" fill="#60a5fa" />
          <circle className="m-particle p3" cx="120" cy="100" r="2" fill="#a78bfa" />
        </g>

        {/* extracted job card pops up (found) */}
        <g className="m-jobcard">
          <rect x="10" y="60" width="38" height="30" rx="4" fill="#fff" stroke="#c7cbe8" strokeWidth="1.4" />
          <rect x="15" y="65" width="20" height="3.5" rx="1.75" fill="#7c3aed" />
          <rect x="15" y="72" width="28" height="2.8" rx="1.4" fill="#d5d8ea" />
          <rect x="15" y="77" width="22" height="2.8" rx="1.4" fill="#d5d8ea" />
          <circle cx="17.5" cy="85" r="2.4" fill="#60a5fa" />
          <rect x="22" y="83" width="9" height="4" rx="2" fill="#a78bfa" />
        ...
        <g className="m-success">
          ...
          <rect className="m-confetti c1" x="30" y="26" width="4" height="4" rx="1" fill="#8b5cf6" />
          ...
          <rect className="m-confetti c4" x="102" y="10" width="3.5" height="3.5" rx="1" fill="#f472b6" />
          <circle className="m-confetti c5" cx="26" cy="50" r="2" fill="#60a5fa" />
          <circle className="m-confetti c6" cx="124" cy="46" r="2" fill="#8b5cf6" />
        </g>
      </svg>
    </div>
  )
